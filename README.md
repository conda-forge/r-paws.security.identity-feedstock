About r-paws.security.identity
==============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-paws.security.identity-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14235&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-paws.security.identity-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-paws.security.identity` can be installed with:

```
conda install r-paws.security.identity
```

It is possible to list all of the versions of `r-paws.security.identity` available on your platform with:
